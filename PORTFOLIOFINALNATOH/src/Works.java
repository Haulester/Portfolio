...
import java.awt.Color;
        ...
        public class Works extends Portfolio { // The class "Works" extends the "Portfolio" class to create a specialized view for displaying the works or projects of the user.
        private JPanel contentPane; // Declare a private instance variable of JPanel type

        // Setting up the Works frame
        public Works() {
        setTitle("Works"); // Set the title of the frame
        ...
        ImageIcon icon = new ImageIcon("backround 3.png"); // Create an ImageIcon with the specified image file
