...
import java.awt.Color;
        ...
        public class AboutMe extends Portfolio { // The class "AboutMe" extends the "Portfolio" class to create a specialized view for displaying information about the user.
        private JPanel contentPane; // Declare a private instance variable of JPanel type

         // Setting up the AboutMe frame
        public AboutMe() {
        setTitle("About Me"); // Set the title of the frame
        ...
        ImageIcon icon = new ImageIcon("backround 2.png"); // Create an ImageIcon with the specified image file
