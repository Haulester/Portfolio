...
import java.awt.Color;
        ...
        public class Contacts extends Portfolio { // The class "Contacts" extends the "Portfolio" class to create a specialized view for managing the user's contacts or contact information.
